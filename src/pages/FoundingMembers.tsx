...
const foundingMembersData = [
    {
        ...
        contactDetails: {
            email: "camehakgoel@yahoo.com",
            mobile: "+91 98766 13290",
            address: "# 4A – 4B, Carton Woods, NRI Block, South City, Ludhiana – 142027, Punjab, India"
        },
        image: member3Img,
    },
    {
        ...
        contactDetails: {
            email: "blsaini@live.com",
            mobile: "+91 77101 11005",
    ...
    },
    {
        ...
        contactDetails: {
            email: "fcamittal@gmail.com",
            mobile: "+91 99886 05871",
            address: "H. No.: 438, Ward No.: 29, Jamiat Singh Road, Moga – 142001, Punjab"
        },
        image: member5Img,
    },
    {
        ...
        contactDetails: {
            email: "caavinashkhajuria@gmail.com",
            mobile: "+91 76967 93693",
            address: "# Village Bara, VPO Vijayapur, District Samba, Jammu & Kashmir - 184120"
        },
        image: member1Img,
    },
    {
        ...
        contactDetails: {
            email: "cataranarora@gmail.com",
            mobile: "+91 94645 25723",
            address: "#549, Alamgir Enclave, Near J K Resort, Malerkotla Road, Ludhiana – 141116, Punjab"
        },
        image: member4Img,
    }
                ...
                {foundingMembersData.map((member, index) => (
                    ...
                    >
                        ...
                        <div className="mt-6 text-sm text-gray-600">
                            <p>
                                <strong>Email:</strong> {member.contactDetails.email}
                            </p>
                            <p>
                                <strong>Mobile:</strong> {member.contactDetails.mobile}
                            </p>
                            <p>
                                <strong>Address:</strong> {member.contactDetails.address}
                            </p>
                        </div>
                    </div>
                ))}
